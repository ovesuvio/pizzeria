  ...
  return (
    <div>
      ...
      <div className="grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: 12 }}>
        ...
        <Link className="card" href="/admin/products"><div className="card-body"><div className="card-title">Prodotti</div><div className="card-desc">Modifica, elimina, aggiungi</div></div></Link>
